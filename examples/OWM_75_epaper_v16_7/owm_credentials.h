...
const char* ssid     = "3pp5khc49";     // WiFi SSID to connect to
const char* password = "a3b2cd5ef73ck11x"; // WiFi password needed for the SSID

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "32352b9140d275b73c69d8b79bf5caf3";                      // See: https://openweathermap.org/  // It's free to get an API key, but don't take more than 60 readings/minute!
...
String LAT              = "52.20";                         // Home location Latitude
String LON              = "8.05";                          // Home location Longitude

String City             = "Georgsmarienhuette";                      // Your home city See: http://bulk.openweathermap.org/sample/
